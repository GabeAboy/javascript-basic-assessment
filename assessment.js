...
//#7 Create an array of strings that are the
//7 primary colors in the rainbow -
//red, orange, yellow, green, blue, indigo, violet (lower-case).
...
// It looks to see if the person’s name is Jeremy and then changes the person
//object to have a property called lovesCode with a value of 10.
...
// #16 Create a function called callerBack that takes in a function
// (holla) and a string parameter(back) and invokes it(holla) with the
//argument string(back) + ' back'."
// example - If I call you with 'Give it' you should invoke holla
// with 'Give it back'
